                    ...
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ flex: 0.5, borderRightWidth: 1, borderRightColor: '#aaa' }}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', paddingBottom: 10, alignItems: 'center' }}>
                                ...
                                <View style={{ flex: 0.4 }}><Text style={{ color: '#204677', textAlign: 'left', marginLeft: 10 }}>{this.strings.Status} </Text></View>
                                <View style={{ flex: 0.4 }}><Text style={{ textAlign: 'left', marginLeft: 5, fontSize: 10 }}>{(deal.Status != null && deal.Status != '') ? deal.Status : this.strings.NoData}</Text></View>
                        ...
                        <View style={{ flex: 0.5 }}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', paddingBottom: 10 }}>
                                ...
                                <View style={{ flex: 0.4 }}><Text style={{ color: '#204677', textAlign: 'left', marginLeft: 10 }}>{this.strings.Status} </Text></View>
                                <View style={{ flex: 0.4 }}><Text style={{ textAlign: 'left', marginLeft: 10, fontSize: 11 }}>{(deal.TafweejType != null && deal.TafweejType != '') ? deal.TafweejType : this.strings.NoData}</Text></View>
                            </View>
                            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', paddingBottom: 10 }}>
                                ...
                                <View style={{ flex: 0.4 }}><Text style={{ color: '#204677', textAlign: 'left', marginLeft: 10 }}>{this.strings.toCity} </Text></View>
                                <View style={{ flex: 0.4 }}><Text style={{ textAlign: 'left', marginLeft: 10, fontSize: 11 }}>{(deal.ToCity != null && deal.ToCity != '') ? deal.ToCity : this.strings.NoData}</Text></View>
                            </View>
                        </View>
                    </View>
