...
import TafweejItem from './TafweejItem'
import user from "../data/userLanguage";
import ajax from '../ajax';

class TafweejList extends  React.Component {
    constructor(props) {
        super(props);
    ...
    render(){
        return(
            ...
            renderItem={({item}) => <TafweejItem deal={item} onPress={this.props.onItemPress}/>}
